# Based off of https://github.com/andreasberg/teensy-template
...
OPTIONS = -DUSB_SERIAL_HID -DLAYOUT_US_ENGLISH -DCORE_TEENSY
...
COREPATH = $(ARDUINO_PATH)/hardware/teensy/avr/cores/teensy3
